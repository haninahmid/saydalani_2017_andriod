...
public class NightOpenPharmacy extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_night_open_pharmacy);
        listView =(ListView)findViewById(R.id.listOpenNight);
        provinsiList=new ArrayList<>();
        // to show the list at the beiging
        showList();
        Button re = (Button) findViewById(R.id.buttonreturnni);
        ...
        Button ser = (Button) findViewById(R.id.buttonserchni);
        final EditText phName=(EditText)findViewById(R.id.editTextNameni);
        final EditText addressName=(EditText)findViewById(R.id.editTextaddressni);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent myIntent = new Intent(NightOpenPharmacy.this, pharmacyMap.class);
                ...
                NightOpenPharmacy.this.startActivity(myIntent);
            }
        });
        Button home =(Button) findViewById(R.id.buttonhome6);
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(NightOpenPharmacy.this, MainActivity.class);
                NightOpenPharmacy.this.startActivity(myIntent);
            }
        });
    }
    ...
    {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://10.0.2.2:8888/saydlani%20app%20Connect/NightyOpen.php",
