...
public class ListPharActivity extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showList();
        Button re = (Button) findViewById(R.id.buttonreturn);
        ...
        Button ser = (Button) findViewById(R.id.buttonserch);
        final EditText phName=(EditText)findViewById(R.id.editTextName);
        final EditText addressName=(EditText)findViewById(R.id.editTextaddress);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent myIntent = new Intent(ListPharActivity.this, pharmacyMap.class);
                ...
                ListPharActivity.this.startActivity(myIntent);
            }
        });

        Button home =(Button) findViewById(R.id.buttonhome5);
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(ListPharActivity.this, MainActivity.class);
                ListPharActivity.this.startActivity(myIntent);
            }
        });
    }
    ...
    {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://10.0.2.2:8888/saydlani%20app%20Connect/allPharmacy.php",
